...
<img src="https://capsule-render.vercel.app/api?type=waving&color=DC143C,A8001E,6B0015&height=320&section=header&text=Notes%20API&fontSize=96&fontAlignY=38&animation=twinkling&fontColor=ffffff&desc=REST+API+%C2%B7+Node.js+%C2%B7+Express+%C2%B7+MongoDB+%C2%B7+MVC&descAlignY=58&descSize=20&descColor=FFCDD5" />
...
<p align="center">
  ...
  &nbsp;
  <img src="https://img.shields.io/badge/Status-Active-8B0000?style=flat-square&labelColor=6B0015" />
</p>
...
|:-------:|:--------:|:----|
| 🚀 Backend API | Render | _link after deployment_ |
| 🗄️ Database | MongoDB Atlas | Managed Cloud Cluster |
...
| **Fields not sent** | ⚠️ Reset to defaults | ✅ Kept unchanged |
...
4. Deploy — Render provides the live URL automatically.
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=DC143C,A8001E,6B0015&height=200&section=footer&text=Clean+REST&fontSize=48&fontAlignY=70&animation=twinkling&fontColor=ffffff" />
